...
// import React, { useState, useEffect, useContext } from 'react';
// import { View, Text, FlatList, TouchableOpacity, StyleSheet, Image, Dimensions, SafeAreaView, ActivityIndicator } from "react-native";
// import { useNavigation } from "@react-navigation/native";
...
//     const { 
//         cart = [], 
//         addToCart = () => { console.log('Default addToCart called'); }, // Add log if default is used
//         removeFromCart = () => {}, 
//         updateQuantity = () => {}, 
//         cartQuantity = 0,
...
//         console.log('Item ID:', item.id, 'Loading Items:', Array.from(loadingItems));

//         const cartItem = {
//             id: item.id,
//             name: item.title,
//             price: item.variants[0].discountPrice || item.variants[0].price,
//             quantity: 1
//         };
...
//                                 <Text 
//                                     style={{ fontWeight: 'bold', fontSize: 17, marginTop: 10, textAlign: 'center' }}
//                                     numberOfLines={2}
//                                     ellipsizeMode="tail"
//                                 >
//                                     {item?.title}
...
//                                             <ActivityIndicator size="small" color="#EC4505" />
//                                         ) : (
//                                             <Image
//                                                 style={{ height: 20, width: 20 }}
//                                                 source={require('../assets/Fast Cart.png')}
